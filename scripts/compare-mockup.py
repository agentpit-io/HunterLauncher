...
PAIRS_BY_MILESTONE = {
    ...
    "M3": [
        ("01-运行面板.png", "hunter-launcher-03-运行面板.jpg", "对照-03-运行面板.png"),
    ],
    "M2": [
    ...
    # I4 把「输入 key」挪到了第二步，所以它的截图编号是 03（I3 之前是 04）。
    # 对照图上因此能直接看出步骤条的顺序变了 —— 视觉稿那一侧仍然是旧顺序，
    # 这是**有意的偏离**，原因写在 I4 报告里。
    "I4": [
        ("03-输入key-已验证.png", "hunter-launcher-01-输入key.jpg", "对照-01-输入key.png"),
        ("07-拉取镜像-真实进度.png", "hunter-launcher-02-拉取镜像.jpg", "对照-02-拉取镜像.png"),
        ("10-运行面板.png", "hunter-launcher-03-运行面板.jpg", "对照-03-运行面板.png"),
    ],
}
