...
const zhCN = {
  ...
  consent: {
    ...
    intro:
      '安装中如果遇到问题，AI 会自己查原因、自己解决，你不用看懂任何报错。整个过程会实时显示在屏幕上，做了什么、为什么这么做，一条都不会藏着。',
    willTitle: 'AI 会做的',
    will: [
  ...
  settings: {
    sectionAssist: 'AI 助手',
    assistMode: '授权档位',
    assistModeHint: '决定 AI 在安装出问题时能自己做到哪一步。什么时候做的授权也记在下面。',
    assistModeAuto: '自动驾驶（推荐）',
    assistModeAutoHint: '只动 Hunter 自己东西的操作直接做，做完告诉你；要装新软件、要动你已有的 Hunter 仍然会先问。',
    assistModeConfirm: '逐步确认',
    assistModeConfirmHint: '每一个会改动的操作都先弹出来给你看，你点了才做。',
    assistModeOff: '关闭',
